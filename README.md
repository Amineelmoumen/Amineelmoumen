...
|----------|--------|---------------|
| **Programming Languages** | Python, Java, JavaScript, C, C++, HTML, CSS | Certifications, projects (DevMobile, Todo App) |
| **AI & ML** | Machine Learning, Deep Learning, NLP, Transformers, AutoML, Online Learning, Feature Engineering, Model Evaluation | Transformer NLP project, Auto-ML project, IBM AI certifications |
| **LLM & Generative AI** | RAG, Prompt Engineering, AI Assistants, LLM Integration | IBM Generative AI certification, RAG implementation in projects |
| **Data Science** | Data Preprocessing, Data Analysis, EDA, Data Visualization | IBM Data Science certifications, project work |
| **MLOps** | MLOps, Model Deployment, ML Pipelines, Experiment Tracking | DevOps certifications, ML project deployment |
| **Backend** | REST API, FastAPI, Django, Node.js, Express, Laravel | IBM Back-End certifications, internship projects |
| **Frontend** | React, Next.js, Tailwind, Bootstrap | IBM Front-End certifications, project work |
| **Databases** | PostgreSQL, MySQL, MongoDB, SQL | IBM SQL certification, project databases |
| **DevOps** | Docker, GitHub Actions, CI/CD, Linux | IBM DevOps certification, 15-course specialization |
| **Software Engineering** | OOP, Clean Code, Modular Development, Git | Core Java certification, software projects |
